...
router.register(r'account-categories', views.AccountCategoryViewSet)
router.register(r'industries', views.IndustryViewSet)
router.register(r'type-of-businesses', views.TypeOfBusinessViewSet)
router.register(r'account-addresses', views.AccountAddressViewSet)
router.register(r'account-pics', views.AccountPICViewSet)
router.register(r'account-banks', views.AccountBankViewSet)
router.register(r'banks', views.BankViewSet)
router.register(r'banks/categories', views.BankCategoryViewSet)
